package com.playrobotic;

import com.playrobotic.database.DatabaseManager;
import com.playrobotic.model.*;
import com.playrobotic.model.Pedido.ItemPedido;
import com.playrobotic.service.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("\n=== PlayRobotic: PDV de Eletronicos ===");
    ...
    private static void relatorioVendasPorCliente() {
        ...
        if (resp.equalsIgnoreCase("s")) {
            System.out.println("Formato esperado: AAAA-MM-dd HH:mm:ss");
